...
div.cont(class='text-body-medium')
    ...
    div(class='ma-6')
        ...
        p(class='text-body-large mb-4') {{$t("This is a free app for printing Scripture and we highly recommend watching the very short introduction video before using it.")}}
