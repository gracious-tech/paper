 ...
 *
 * Forked from mdbassit/Coloris 0.25.0 (MIT); vendored into paper_bible from the bookcover
 * repo's fork (github.com/gracious-tech/bookcover). Local patches, each marked [FORK]:
