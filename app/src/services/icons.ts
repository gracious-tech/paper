...
// Curated suggestions, grouped by theme. Kept identical to the bookcover widget's set so both
// apps offer the same icons (see gracious-tech/bookcover widget/src/services/icons.ts).
export const biblical_icons:string[] = [
